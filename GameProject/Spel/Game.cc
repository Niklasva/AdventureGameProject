...
void Game::read_file(const QString& filename)
{
       ...
       if (file.open(QIODevice::ReadOnly))
       {
           ...
           while ( !in.atEnd() )
           {
              ...
              cout << "VI LÄSER " << line.toStdString() << "\t" << is_reading.toStdString() << endl;
              ...
              if (is_reading == "Room")
              {
                  ...
                  {
                      cout << "Now we are done reading room " << ++i << endl;

                      cout << temp_room.n_ << " " << temp_room.s_ << " " << temp_room.e_ << " " << temp_room.w_ << "\n";
              ...
              else if (is_reading == "Person")
              {
                  if (line.startsWith("Name"))
                      ...
                      temp_person.set_received_item_dialog(line.split(": ").last());
              ...
              else if (is_reading == "Merchant")
              {
                  if (line.startsWith("Name"))
                      ...
                      temp_merchant.set_description(line.split(": ").last());
                  else if (line.startsWith("Dialog"))
                      temp_merchant.set_dialog(line.split(": ").last());
                  else if (line.startsWith("Recieved item dialog"))
                      temp_merchant.set_received_item_dialog(line.split(": ").last());
                  else if (line.startsWith("Hair"))
